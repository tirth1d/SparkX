    ...
    if (m[o]) {
      ...
      if (((w = o), n)) e(R.target).stop().scrollTop(O), i && R.after(o, g);
        ...
        if (
          ((x = !0),
          e().velocity
            ? e(R.target).stop().velocity("scroll", {
            ...
            : e(R.target)
                .stop()
                .animate({ scrollTop: O }, R.scrollSpeed, R.easing),
          ...
          e(r).each(function (o) {
            ...
            (p[o] =
              ...
              R.sectionName && n.data(R.sectionName)
                ? (m[o] =
                    "#" + n.data(R.sectionName).toString().replace(/ /g, "-"))
                ...
                : ((m[o] = "#"),
                  o === e(r).length - 1 &&
                    ...
                    (p[o] =
                      p[o - 1] +
                      (parseInt(e(e(r)[o - 1]).outerHeight()) -
                        parseInt(e(t).height())) +
      ...
      (L = !0),
        ...
        (h = {
          ...
          calculateNearest: function (e, t) {
            E = b.scrollTop();
            for (
              var o, n = 1, r = p.length, s = 0, a = Math.abs(p[0] - E);
              n < r;
              n++
            )
          ...
          wheelHandler: function (o) {
            ...
            if (
              ...
              (e(o.target).is(R.standardScrollElements) ||
                e(o.target).closest(R.standardScrollElements).length)
            )
              return !0;
          ...
          touchHandler: function (t) {
            ...
            if (
              ...
              (e(t.target).is(R.standardScrollElements) ||
                e(t.target).closest(R.standardScrollElements).length)
            )
              return !0;
            var o;
                ...
                case "touchmove":
                  (f.touches.touchmove.y = o.pageY),
                    ...
                    f.touches.touchstart.y !== f.touches.touchmove.y &&
                      Math.abs(f.touches.touchstart.y - f.touches.touchmove.y) >
                        Math.abs(
                          f.touches.touchstart.x - f.touches.touchmove.x
                        ) &&
                      (t.preventDefault(),
                      (f.touches.direction = "y"),
                      f.options.timeStamp + f.options.timeGap <
                        new Date().getTime() &&
                        0 == f.touches.touchend &&
                        ((f.touches.touchend = !0),
                        f.touches.touchstart.y > -1 &&
                          Math.abs(
                            f.touches.touchmove.y - f.touches.touchstart.y
                          ) > f.options.distance &&
                          (f.touches.touchstart.y < f.touches.touchmove.y
                            ? f.up()
                            : f.down())));
              ...
              (j() && y < p.length - 1
                ...
                : ((l = r()),
                  Math.floor(g[y].height() / l) > S
                    ...
                    : a(parseInt(p[y]) + (g[y].outerHeight() - l))));
          },
          up: function () {
            y >= 0 &&
              (O() && y > 0
          ...
          init: function () {
            if (o.addEventListener && R.touchScroll) {
              ...
              o.addEventListener("touchstart", f.touchHandler, e),
                o.addEventListener("touchmove", f.touchHandler, e),
                o.addEventListener("touchend", f.touchHandler, e);
            }
          },
        }),
        (d = {
        ...
        p.length &&
          ...
          o.addEventListener &&
            t.addEventListener("orientationchange", d.handleOrientation, !1));
    };
  return (
    (j.move = function (t) {
      if (t === n) return !1;
